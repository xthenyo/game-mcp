...
${chalk.bold('PREREQUISITES:')}
  - Node.js 18+    ${chalk.dim('https://nodejs.org')}
  - Python 3.11+   ${chalk.dim('https://python.org/downloads')}
  - uv             ${chalk.dim('curl -LsSf https://astral.sh/uv/install.sh | sh')}
  - Git            ${chalk.dim('https://git-scm.com/downloads')}
